...
| [Upgrade guide](docs/UPGRADE.md) | Version upgrade paths |
| [API stability](docs/API_STABILITY.md) | Semver guarantees for 1.x |
| [Scout integration](docs/SCOUT_INTEGRATION.md) | Scout APM driver deep-dive |
| [Benchmarks](docs/BENCHMARKS.md) | Instrumentation overhead methodology |
